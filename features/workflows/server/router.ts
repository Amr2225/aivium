import { PAGINATION } from "@/config/contsants";
...
export const workflowRouter = createTRPCRouter({
    ...
    updateName: protectedProcedure.input(z.object({ id: z.string(), name: z.string().min(3, 'Name must be at least 3 characters long') })).mutation(({ ctx, input }) => {
